var Pagination = function Pagination(obj) {
    ...
    className = obj.className || "pagination pagination-lg",      // 分页样式
    ...
    lastButton && (str += '<li class="page-item"><a class="page-link" href="' + Pagination.replaceUrl(pageParam, max) + '">' + lastButton + "</a></li>"),
    str + "</ul></nav>"
};